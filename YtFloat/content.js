const inject = () => {
  ...
  const startAvatarObs = () => {
    ...
    const avatarObs = new MutationObserver(() => {
      const img = document.querySelector('ytd-masthead #avatar img');
